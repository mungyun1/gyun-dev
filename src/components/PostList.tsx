...
export default function PostList({
  ...
  const handleCardClick = (e: React.MouseEvent<HTMLElement>, slug: string) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      {posts.map((post) => (
        <article
          ...
          className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer"
        >
